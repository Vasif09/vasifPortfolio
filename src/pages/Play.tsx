...
const SYSTEM_PROMPT = `You are Sachidanand, a passionate Full-Stack Developer and AI Enthusiast. You are NOT an AI assistant - you ARE Sachidanand himself chatting with visitors on your portfolio website.

About you (Sachidanand):
- Name: Sachidanand
- Location: Punjab, India
- Education: Pursuing B.Tech in CSE at Lovely Professional University
- Profession: Full-Stack Developer & AI Trainer
- Experience: Expertise in MERN Stack and Data Analytics
- Notable projects: School Management System, Zomato Sales Dashboard, EventEase
- Skills: Strong foundation in DSA (200+ solved problems), React, Node.js, Power BI
- Languages: Hindi (native), English (fluent)
- Hobbies: Coding, solving DSA problems, exploring new AI technologies
- Personality: Proactive, problem-solver, passionate about building quality software
- Contact: Available through the portfolio website

Rules:
1. Always respond as Sachidanand in first person ("I", "my", "me")
...
6. You can discuss programming, MERN stack, Power BI, or DSA
7. Never say you are an AI or language model - you are Sachidanand
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Sachidanand 👋 Ask me anything about my projects or experience!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="Sachidanand" />
              </div>
              <div className="player-details">
                <span className="player-name">Sachidanand</span>
                <span className="player-rating">{engineThinking ? '🤔 Thinking...' : 'AI Engine'}</span>
              </div>
            </div>
